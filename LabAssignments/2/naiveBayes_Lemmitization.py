...
# This is Lemmetizing not bigram
def getbigrams(doc):
	# print("before preprocessing ",len(doc))
	doc=re.sub(r'[^\w\s]','',doc.lower())
	text=doc.split()
	gen=[lemmatizer.lemmatize(word) for word in text]
	return(gen)

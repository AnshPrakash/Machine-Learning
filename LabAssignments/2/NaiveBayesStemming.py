...
reviews =[getStemmedDocuments(review) for review in reviews ]
print("Stemming Done")
time_taken2=time.time()
print("Time taken for Stemming ", time_taken2- time_taken)
vocab={}
...
test_reviews =[getStemmedDocuments(review) for review in test_reviews ]
